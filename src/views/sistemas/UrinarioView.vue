        ...
        <div class="cartoes">
          <div class="cartao">
            <div class="cartaoInterno">
              ...
              <div class="lado-atras">
                <p>
                  A uretrite é um tipo de infecção que afeta a uretra, o canal
                  responsável pela eliminação da urina. Essa condição provoca
                  sintomas como vontade frequente de urinar, dor ou ardor ao
                  urinar e corrimento amarelo. Normalmente, a uretrite é causada
                  por infecções sexualmente transmissíveis, como clamídia,
                  gonorreia, tricomoníase e herpes, mas também pode ocorrer
                  devido a traumas ou irritações na uretra, que podem ser
                  provocadas por produtos químicos. Além disso, infecções
                  bacterianas e virais também podem levar à inflamação da
                  uretra.
                </p>
              </div>
            </div>
