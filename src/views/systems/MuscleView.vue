...
<template>
  <main>
    ...
    </ul>" content2Reference="https://www.neoquimica.com.br/blog/vitaminas/como-funciona-o-sistema-muscular-o-que-e-bom-para-ele"
    organImage="/public/header/muscle.png" organName="Músculo" organh3="Sistema Muscular" organp="O sistema muscular é essencial para o movimento, a postura e funções vitais, como a respiração e a circulação. Composto por músculos esqueléticos, cardíacos e lisos, ele permite a locomoção, estabiliza articulações e protege órgãos. Doenças musculares, como as degenerativas ou inflamatórias, podem prejudicar sua função. Manter a saúde muscular é crucial para a qualidade de vida, exigindo cuidados como exercícios, boa alimentação e tratamentos médicos."
    organReference="ref"
    illness1h3="Miopatias congênitas" illness1p="As miopatias congênitas são um grupo de doenças musculares hereditárias que afetam o funcionamento e a estrutura dos músculos desde o nascimento ou a primeira infância. Há diferentes formas de miopatias congênitas; as mais comuns são: miopatia central, miopatia multiminicore (miopatias centrais), miopatia centronuclear e miopatia nemalínica. Os principais sintomas são a fraqueza muscular, dificuldade para respirar e, em crianças, quedas e tropeços devido à fraqueza. As miopatias congênitas não têm cura atualmente, pois são condições genéticas que afetam a função muscular de forma permanente. O tratamento é focado em supervisionar os sintomas e melhorar a qualidade de vida dos pacientes."
