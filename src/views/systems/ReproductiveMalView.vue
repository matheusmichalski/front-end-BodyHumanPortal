...
<template>
  <main>
    ...
    <ul>
      ...
      organImage="/public/header/sperm.png" organName="Espermatozóide" organh3="Sistema Reprodutor Masculino"
      ...
      organReference="ref" illness1h3="Câncer de próstata"
    ...
    <RouterLink to="/sistema/reprodutor-feminino" id="button"><button>REPRODUTOR FEMININO</button></RouterLink>
  </main>
</template>
