...
<template>
  <main class="is-desktop">
    <systems system="Esquelético" content1p="O corpo humano adulto possui 206 ossos, distribuídos em quatro categorias:
    <ul>
    ...
    <ul>
    ...
    </ul>" content2Reference="ref" organImage="/header/bone.png" illness1h3="Osteoporose"
      ...
      illness1Reference="ref" illness2h3="Câncer ósseo"
      ...
      illness2Reference="ref" illness3h3="Doença de Paget (DPO)"
  ...
  <main class="is-mobile">
    <systemsMobile system="Esquelético" content1p="O corpo humano adulto possui 206 ossos, distribuídos em quatro categorias:
    <ul>
      <li>Ossos longos: Exemplos incluem fêmur e úmero.</li>
      <li>Ossos curtos: Exemplos são os ossos do punho (carpais).</li>
      <li>Ossos chatos: Exemplos incluem esterno e escápula.</li>
