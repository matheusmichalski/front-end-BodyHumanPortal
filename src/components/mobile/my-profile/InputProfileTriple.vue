...
<template>
  <ul>
    ...
    <li class="third">
      <label :class="{ active: focused3 || inputValue3 }" for="password3">{{ labelText3 }}</label>
      <input
      ...
      />
      <font-awesome-icon
        :icon="isPasswordVisible3 ? 'eye-slash' : 'eye'"
        class="icon"
